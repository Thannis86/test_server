...
5. To find the rows/column names, change the 'moods' const on line 43 to the name of the table you want to get the information from, then submit a get request to 'localhost:8080/data'. The information will appear in the console
